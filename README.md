...
performance: 
Advanced Modeling
- EAicientNet or Vision Transformers
- Multi-task learning with separate attribute heads
...
python train.py 
python inference.py 
        Modify the image path in the script as needed. 
